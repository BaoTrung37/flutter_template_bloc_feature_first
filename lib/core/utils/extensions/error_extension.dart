...
import 'package:example_flutter_app/core/error/api_error.dart';
import 'package:firebase_core/firebase_core.dart';

extension EitherCast<T> on Future<T> {
  Future<Either<ServerError, T>> handleError() async {
    return Task(() => this)
        .attempt()
        .map(
...
ServerError mapFireBaseError(FirebaseException obj) {
  switch (obj.code) {
    ...
    case 'unimplemented':
      return ServerError(
        errorCode: ErrorCode.unimplemented,
        developerText: obj.message,
      );
    case 'unknown':
      return const ServerError(
